                    ...
                    <div className="services__modal-content">
                        ...
                        <ul className="services__modal-services grid">
                            <li className="services__modal-service">
                                ...
                                <p className="service__modal-info">I design user interface</p>
                            </li>
                        </ul>
                        ...
                        <ul className="services__modal-services grid">
                            <li className="services__modal-service">
                                <i className="uil uil-check-circle services__modal-icon"></i>
                                <p className="service__modal-info">Website development</p>
                            </li>
                        </ul>
                        ...
                        <ul className="services__modal-services grid">
                            <li className="services__modal-service">
                                <i className="uil uil-check-circle services__modal-icon"></i>
                                <p className="service__modal-info">I help in SEO intergration</p>
                            </li>
                        </ul>
                    </div>
                </div>
